 ...
 */
public class FastIndexRequest extends ReplicatedWriteRequest<FastIndexRequest> implements FastDocWriteRequest<FastIndexRequest>, CompositeIndicesRequest {
    @Nullable
    private String shardNo;

    @Override
    public FastIndexRequest shardNo(String shardNo) {
     ...
     */
    public FastIndexRequest(String index) {
        this.index = index;
    }
     ...
     * {@link #source(byte[], XContentType)} must be set.
     */
    public FastIndexRequest(String index, String type) {
        this.index = index;
        this.type = type;
    }
     ...
     */
    public FastIndexRequest(String index, String type, String id) {
        this.index = index;
        this.type = type;
        this.id = id;
    }
     ...
     */
    @Override
    public FastIndexRequest type(String type) {
        this.type = type;
        return this;
    }
     ...
     */
    public FastIndexRequest id(String id) {
        this.id = id;
        return this;
    }
     ...
     */
    @Override
    public FastIndexRequest routing(String routing) {
     ...
     */
    public FastIndexRequest parent(String parent) {
        this.parent = parent;
        return this;
    }
     ...
     */
    public FastIndexRequest setPipeline(String pipeline) {
     ...
     */
    public FastIndexRequest source(Map source) throws ElasticsearchGenerationException {
     ...
     * @param source The map to index
     */
    public FastIndexRequest source(Map source, XContentType contentType) throws ElasticsearchGenerationException {
        try {
     ...
     */
    public FastIndexRequest source(String source, XContentType xContentType) {
     ...
     */
    public FastIndexRequest source(XContentBuilder sourceBuilder) {
     ...
     * </p>
     */
    public FastIndexRequest source(Object... source) {
     ...
     * </p>
     */
    public FastIndexRequest source(XContentType xContentType, Object... source) {
     ...
     */
    public FastIndexRequest source(BytesReference source, XContentType xContentType) {
     ...
     * Sets the document to index in bytes form.
     */
    public FastIndexRequest source(byte[] source, XContentType xContentType) {
     ...
     */
    public FastIndexRequest source(byte[] source, int offset, int length, XContentType xContentType) {
     ...
     */
    public FastIndexRequest opType(OpType opType) {
     ...
     */
    public FastIndexRequest opType(String opType) {
     ...
     */
    public FastIndexRequest create(boolean create) {
        if (create) {
    ...
    @Override
    public FastIndexRequest version(long version) {
    ...
    @Override
    public FastIndexRequest versionType(VersionType versionType) {
     ...
     */
    @Override
    public FastIndexRequest setIfSeqNo(long seqNo) {
     ...
     */
    @Override
    public FastIndexRequest setIfPrimaryTerm(long term) {
        if (term < 0) {
     ...
     */
    @Override
    public FastIndexRequest setShardId(ShardId shardId) {
