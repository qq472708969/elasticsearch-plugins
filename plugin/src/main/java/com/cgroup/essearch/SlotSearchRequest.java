 ...
 */
public class SlotSearchRequest extends ActionRequest implements IndicesRequest.Replaceable {
    private static final DeprecationLogger DEPRECATION_LOGGER = new DeprecationLogger(LogManager.getLogger(SlotSearchRequest.class));
     ...
     */
    public SlotSearchRequest(SlotSearchRequest searchRequest) {
     ...
     */
    public SlotSearchRequest(String... indices) {
     ...
     */
    public SlotSearchRequest(String[] indices, SearchSourceBuilder source) {
        this();
        if (source == null) {
     ...
     * milliseconds from the epoch time and whether the reduction should be final or not. Used when a {@link SlotSearchRequest} is created
     ...
     */
    SlotSearchRequest(String localClusterAlias, long absoluteStartMillis, boolean finalReduce) {
     ...
     * request. When created through {@link #SlotSearchRequest(String, long, boolean)}, this method returns the provided current time, otherwise
     ...
     */
    @Override
    public SlotSearchRequest indices(String... indices) {
    ...
    public SlotSearchRequest indicesOptions(IndicesOptions indicesOptions) {
     ...
     * all types.
     */
    public SlotSearchRequest types(String... types) {
     ...
     * A comma separated list of routing values to control the shards the search will be executed on.
     */
    public SlotSearchRequest routing(String routing) {
     ...
     */
    public SlotSearchRequest routing(String... routings) {
     ...
     */
    public SlotSearchRequest preference(String preference) {
     ...
     */
    public SlotSearchRequest searchType(SearchType searchType) {
     ...
     */
    public SlotSearchRequest searchType(String searchType) {
     ...
     */
    public SlotSearchRequest source(SearchSourceBuilder sourceBuilder) {
     ...
     * If set, will enable scrolling of the search request.
     */
    public SlotSearchRequest scroll(Scroll scroll) {
        this.scroll = scroll;
        return this;
    }
     ...
     */
    public SlotSearchRequest scroll(TimeValue keepAlive) {
     ...
     * If set, will enable scrolling of the search request for the specified timeout.
     */
    public SlotSearchRequest scroll(String keepAlive) {
     ...
     */
    public SlotSearchRequest requestCache(Boolean requestCache) {
     ...
     */
    public SlotSearchRequest allowPartialSearchResults(boolean allowPartialSearchResults) {
    ...
    public boolean equals(Object o) {
        ...
        SlotSearchRequest that = (SlotSearchRequest) o;
