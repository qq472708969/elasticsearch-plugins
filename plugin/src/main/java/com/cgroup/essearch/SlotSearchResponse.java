...
import com.cgroup.essearch.base.SearchResponseSections;
 ...
 */
public class SlotSearchResponse extends ActionResponse implements StatusToXContentObject {
    ...
    public static SlotSearchResponse fromXContent(XContentParser parser) throws IOException {
        ensureExpectedToken(XContentParser.Token.START_OBJECT, parser.nextToken(), parser::getTokenLocation);
        parser.nextToken();
        return innerFromXContent(parser);
    }

   public static SlotSearchResponse innerFromXContent(XContentParser parser) throws IOException {
        ...
        return new SlotSearchResponse(searchResponseSections, scrollId, totalShards, successfulShards, skippedShards, tookInMillis,
