...
import com.cgroup.essearch.SlotSearchResponse;
import com.cgroup.essearch.SlotSearchTransportAction;
...
public abstract class AbstractSearchAsyncAction<Result extends SearchPhaseResult> extends InitialSearchPhase<Result>
    ...
    private final ActionListener<SlotSearchResponse> listener;
    private final SlotSearchRequest request;
    /**
    ...
    private final SlotSearchTransportAction.SearchTimeProvider timeProvider;
    private final SlotSearchResponse.Clusters clusters;

   public AbstractSearchAsyncAction(String name, Logger logger, SlotSearchTransportService searchTransportService,
                              BiFunction<String, String, Transport.Connection> nodeIdToConnection,
                              Map<String, AliasFilter> aliasFilter, Map<String, Float> concreteIndexBoosts,
                              Map<String, Set<String>> indexRoutings,
                              Executor executor, SlotSearchRequest request,
                              ActionListener<SlotSearchResponse> listener, GroupShardsIterator<SearchShardIterator> shardsIts,
                              SlotSearchTransportAction.SearchTimeProvider timeProvider, long clusterStateVersion,
    ...
    public final void start() {
        if (getNumShards() == 0) {
            ...
            listener.onResponse(new SlotSearchResponse(InternalSearchResponse.empty(), null, 0, 0, 0, buildTookInMillis(),
    ...
    @Override
    public final SlotSearchRequest getRequest() {
        return request;
    }

    @Override
    public final SlotSearchResponse buildSearchResponse(InternalSearchResponse internalSearchResponse, String scrollId) {
        ...
        return new SlotSearchResponse(internalSearchResponse, scrollId, getNumShards(), successfulOps.get(),
    ...
    @Override
    public final SlotSearchTransportService getSearchTransport() {
    ...
    @Override
    public final void onResponse(SlotSearchResponse response) {
