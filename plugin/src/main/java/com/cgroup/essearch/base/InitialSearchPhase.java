...
abstract class InitialSearchPhase<FirstResult extends SearchPhaseResult> extends SearchPhase {
    ...
    InitialSearchPhase(String name, SlotSearchRequest request, GroupShardsIterator<SearchShardIterator> shardsIts, Logger logger,
    ...
    abstract static class SearchPhaseResults<Result extends SearchPhaseResult> {
         ...
         */
        SlotSearchPhaseController.ReducedQueryPhase reduce() {
