...
import com.cgroup.essearch.SlotSearchRequestBuilder;
...
public class MultiSearchRequest extends ActionRequest implements CompositeIndicesRequest {
    ...
    private List<SlotSearchRequest> requests = new ArrayList<>();
...
//    }
     ...
     * same order as the search requests.
     */
    public MultiSearchRequest add(SlotSearchRequest request) {
    ...
    public List<SlotSearchRequest> requests() {
    ...
    public void writeTo(StreamOutput out) throws IOException {
        ...
        for (SlotSearchRequest request : requests) {
            request.writeTo(out);
        }
    }
    ...
    public static byte[] writeMultiLineFormat(MultiSearchRequest multiSearchRequest, XContent xContent) throws IOException {
        ...
        for (SlotSearchRequest request : multiSearchRequest.requests()) {
    ...
    public static void writeSearchRequestParams(SlotSearchRequest request, XContentBuilder xContentBuilder) throws IOException {
        xContentBuilder.startObject();
