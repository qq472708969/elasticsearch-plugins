...
public class MultiSearchResponse extends ActionResponse implements Iterable<MultiSearchResponse.Item>, ToXContentObject {
    ...
    public static class Item implements Streamable {
        private SlotSearchResponse response;
        ...
        public Item(SlotSearchResponse response, Exception exception) {
         ...
         */
        @Nullable
        public SlotSearchResponse getResponse() {
        ...
        public void readFrom(StreamInput in) throws IOException {
            if (in.readBoolean()) {
                this.response = new SlotSearchResponse();
            ...
            switch (token) {
                case FIELD_NAME:
                    ...
                    if ("error".equals(fieldName)) {
                        ...
                        item = new Item(SlotSearchResponse.innerFromXContent(parser), null);
                        break outer;
                    }
                    break;
                case VALUE_NUMBER:
