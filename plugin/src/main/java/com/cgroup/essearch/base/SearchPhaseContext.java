 ...
 */
interface SearchPhaseContext extends ActionListener<SlotSearchResponse>, Executor {
     ...
     */
    SlotSearchResponse buildSearchResponse(InternalSearchResponse internalSearchResponse, String scrollId);
