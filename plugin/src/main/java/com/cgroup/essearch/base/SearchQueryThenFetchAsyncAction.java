...
public final class SearchQueryThenFetchAsyncAction extends AbstractSearchAsyncAction<SearchPhaseResult> {
    ...
    public SearchQueryThenFetchAsyncAction(final Logger logger, final SlotSearchTransportService searchTransportService,
                                           ...
                                           long clusterStateVersion, SearchTask task, SlotSearchResponse.Clusters clusters) {
