...
import com.cgroup.essearch.internal.ShardSearchLocalRequest;
...
public class ShardSearchTransportRequest extends TransportRequest implements ShardSearchRequest, IndicesRequest {
    ...
    public ShardSearchTransportRequest(OriginalIndices originalIndices, SlotSearchRequest searchRequest, ShardId shardId, int numberOfShards,
