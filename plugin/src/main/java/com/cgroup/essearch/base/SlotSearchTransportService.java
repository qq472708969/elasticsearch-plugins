 ...
 * transport.
 */
public class SlotSearchTransportService {

    public static final String FREE_CONTEXT_SCROLL_ACTION_NAME = "indices:data/read/search_by_slot[free_context/scroll]";
    public static final String FREE_CONTEXT_ACTION_NAME = "indices:data/read/search_by_slot[free_context]";
    public static final String CLEAR_SCROLL_CONTEXTS_ACTION_NAME = "indices:data/read/search_by_slot[clear_scroll_contexts]";
    public static final String DFS_ACTION_NAME = "indices:data/read/search_by_slot[phase/dfs]";
    public static final String QUERY_ACTION_NAME = "indices:data/read/search_by_slot[phase/query]";
    public static final String QUERY_ID_ACTION_NAME = "indices:data/read/search_by_slot[phase/query/id]";
    public static final String QUERY_SCROLL_ACTION_NAME = "indices:data/read/search_by_slot[phase/query/scroll]";
    public static final String QUERY_FETCH_SCROLL_ACTION_NAME = "indices:data/read/search_by_slot[phase/query+fetch/scroll]";
    public static final String FETCH_ID_SCROLL_ACTION_NAME = "indices:data/read/search_by_slot[phase/fetch/id/scroll]";
    public static final String FETCH_ID_ACTION_NAME = "indices:data/read/search_by_slot[phase/fetch/id]";
    public static final String QUERY_CAN_MATCH_NAME = "indices:data/read/search_by_slot[can_match]";
    ...
    @Inject
    public SlotSearchTransportService(TransportService transportService, ClusterService clusterService) {
        final ResponseCollectorService responseCollectorService = new ResponseCollectorService(clusterService);
        this.transportService = transportService;
        this.responseWrapper = SearchExecutionStatsCollector.makeWrapper(responseCollectorService);
    }
